<?php
    ...
    if(isset($_POST['submit'])){
        ...
        $query = "INSERT INTO `mm_record`(`trn_date`,`categorymm`,`section`,`personincharge`,`yearsofexperiences`,`descriptionmm`,`file_path`,`submittedby`)VALUES ('$trn_date','$categorymm','$section','$personincharge','$yearsofexperiences','$descriptionmm','$path_filename_ext','$submittedby')";
...
<head>
    <meta charset="utf-8">
    <title>Database MAXIMO/MICROSOFT</title>
</head>
        ...
        <div class="row display-table-row">
            ...
            <div class="col-md-10 col-sm-11 display-table-cell v-align">
                ...
                <div class="user-dashboard">
                    <h1>Database Maximo / Microsoft</h1>
