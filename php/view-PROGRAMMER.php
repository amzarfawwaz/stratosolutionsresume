    ...
    <div class="container-fluid display-table">
        <div class="row display-table-row">
            <div class="col-md-2 col-sm-1 hidden-xs display-table-cell v-align box" id="navigation">
                ...
                <div class="navi">
                    <ul>
                        ...
                        <li class="active"><a href="view-PROGRAMMER.php"><i class="fa fa-dashboard" aria-hidden="true"></i><span class="hidden-xs hidden-sm">View Record Programmer</span></a></li>
                        <li><a href="insert-PROGRAMMER.php"><i class="fa fa-tasks" aria-hidden="true"></i><span class="hidden-xs hidden-sm">Insert Record Programmer</span></a></li>
            ...
            <div class="col-md-10 col-sm-11 display-table-cell v-align">
                ...
                <div class="form">
                    <h2>View Records for Programmer</h2>
                    <br><br>
                    <table class="table table-sm table-dark" width="100%" border="1" style="border-collapse:collapse;">
                        ...
                        <tbody>
                            <?php
                    $count=1;
                    $sel_query="Select * from programmer_record ORDER BY id desc;";
                    $result = mysqli_query($con,$sel_query);
                    while($row = mysqli_fetch_assoc($result)) { ?>
                            <tr>
                                <td align="center"><?php echo $count; ?></td>
                                <td align="center"><?php echo $row["categoryprogrammer"]; ?></td>
                                ...
                                <td align="center"><?php echo $row["descriptionprogrammer"]; ?></td>
                                 <td align="center">
                                ...
                                <td align="center">
                                    <a href="edit-PROGRAMMER.php?id=<?php echo $row["id"]; ?>">Edit</a>
                                </td>
                                <td align="center">
                                    <a href="delete-PROGRAMMER.php?id=<?php echo $row["id"]; ?>" onclick="return confirm('Are you sure you want to delete this item?');">Delete</a>
                                </td>
                            </tr>
                            <?php $count++; } ?>
                        </tbody>
