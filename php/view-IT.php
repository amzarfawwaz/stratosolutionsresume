            ...
            <div class="col-md-2 col-sm-1 hidden-xs display-table-cell v-align box" id="navigation">
                ...
                <div class="navi">
                    <ul>
                        ...
                        <li class="active"><a href="view-IT.php"><i class="fa fa-dashboard" aria-hidden="true"></i><span class="hidden-xs hidden-sm">View Record IT</span></a></li>
                        <li><a href="insert-IT.php"><i class="fa fa-tasks" aria-hidden="true"></i><span class="hidden-xs hidden-sm">Insert Record IT</span></a></li>
                ...
                <div class="form">
                    ...
                    <table class="table table-sm table-dark" width="100%" border="1" style="border-collapse:collapse;">
                        ...
                        <tbody>
                            <?php
                    $count=1;
                    $sel_query="Select * from it_record ORDER BY id desc;";
                    $result = mysqli_query($con,$sel_query);
                    while($row = mysqli_fetch_assoc($result)) { ?>
                            <tr>
                                <td align="center"><?php echo $count; ?></td>
                                <td align="center"><?php echo $row["categoryit"]; ?></td>
                                ...
                                <td align="center"><?php echo $row["descriptionit"]; ?></td>
                                 <td align="center">
                                ...
                                <td align="center">
                                    <a href="edit-IT.php?id=<?php echo $row["id"]; ?>">Edit</a>
                                </td>
                                <td align="center">
                                    <a href="delete-IT.php?id=<?php echo $row["id"]; ?>" onclick="return confirm('Are you sure you want to delete this item?');">Delete</a>
                                </td>
                            </tr>
                            <?php $count++; } ?>
                        </tbody>
