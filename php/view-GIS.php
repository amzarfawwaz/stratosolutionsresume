            ...
            <div class="col-md-2 col-sm-1 hidden-xs display-table-cell v-align box" id="navigation">
                ...
                <div class="navi">
                    <ul>
                        ...
                        <li class="active"><a href="view-GIS.php"><i class="fa fa-dashboard" aria-hidden="true"></i><span class="hidden-xs hidden-sm">View Record GIS</span></a></li>
                        <li><a href="insert-GIS.php"><i class="fa fa-tasks" aria-hidden="true"></i><span class="hidden-xs hidden-sm">Insert Record GIS</span></a></li>
                ...
                <div class="form">
                    ...
                    <table class="table table-sm table-dark" width="100%" border="1" style="border-collapse:collapse;">
                        ...
                        <tbody>
                            <?php
                    $count=1;
                    $sel_query="Select * from gis_record ORDER BY id desc;";
                    $result = mysqli_query($con,$sel_query);
                    while($row = mysqli_fetch_assoc($result)) { ?>
                            <tr>
                                <td align="center"><?php echo $count; ?></td>
                                <td align="center"><?php echo $row["categorygis"]; ?></td>
                                ...
                                <td align="center"><?php echo $row["descriptiongis"]; ?></td>
                                 <td align="center">
                                ...
                                <td align="center">
                                    <a href="edit-GIS.php?id=<?php echo $row["id"]; ?>">Edit</a>
                                </td>
                                <td align="center">
                                    <a href="delete-GIS.php?id=<?php echo $row["id"]; ?>"id="delete">Delete</a>
