<?php
    ...
    $id=$_REQUEST['id'];
    $query = "SELECT * from gis_record where id='".$id."'"; 
...
<body class="home">
    <div class="container-fluid display-table">
        ...
        <?php
            ...
            $update="update gis_record set trn_date='".$trn_date."',categorygis='".$categorygis."', section='".$section."',personincharge='".$personincharge."',yearsofexperiences='".$yearsofexperiences."',descriptiongis='".$descriptiongis."',submittedby='".$submittedby."' where id='".$id."'";
                
            mysqli_query($con, $update) or die(mysqli_error());
                
            $status = "Record Updated Successfully. </br></br><a href='view-GIS.php'>View Updated Record</a>";
            ...
            ?>
                    ...
                    <form  action="" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <select name="categorygis" class="form-control" required>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="descriptiongis" required></textarea>
                        </div>
                        <!-----------------------DROP RESUME---------------------------->
                        <div class="form-group">
